...
<head>
	...
	<body class="gray-bg">
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="row">
	            <div class="col-sm-12">
	           		<div class="ibox-title"><h5><a href="javascript:void(0)" onclick="javascript:history.back()">返回</a><span style="padding: 0 10px;">|</span>添加系统用户</h5></div>
	           		
	           		<div class="ibox-content">
						<form action="${path}/back/control/sysUserManage/add" method="post" id="addForm" class="form-horizontal">
					
							<input type="hidden" value="${query}" name="query" />
							
							<div class="form-group">
							    <label class="col-sm-2 control-label"><font color="#FF0000">*</font>用户名：</label>
							    <div class="col-sm-10">
